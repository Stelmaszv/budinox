<?php
 class mian_page_not_login{
 	...
 	protected $sql;
      ...
      $this->futer      = new load_content(false,'futer');
  	}
  	function add_Elemts(){
      $this->template->CAdd('[#FUTER#]',$this->futer->view_content());
 ...
 class mian_page extends mian_page_not_login{
       ...
       $this->edition    = new edition(false,"edition");

   	}
  	public function show_all(){ 
        $this->add_Elemts();
        $this->template->CAdd('[#edition#]',$this->edition->view_content());
